                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setResumeUserData((prev) => ({ ...prev, name: e.target.value }))
                            }
                            required
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setResumeUserData((prev) => ({ ...prev, email: e.target.value }))
                            }
                            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-blue-600 focus:ring-2 focus:ring-blue-600"
                        />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setResumeUserData((prev) => ({ ...prev, phone: e.target.value }))
                            }
                            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-blue-600 focus:ring-2 focus:ring-blue-600"
                        />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setResumeUserData((prev) => ({ ...prev, location: e.target.value }))
                            }
                            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-blue-600 focus:ring-2 focus:ring-blue-600"
                        />
                    </div>
