                ...
                <div className="tablet:grid-cols-2 laptop:grid-cols-3 desktop:grid-cols-5 mt-8 grid grid-cols-1 gap-4">
                    {mainWorkFlowSteps.map((s) => {
                        ...
                        return (
                            <div
                                key={s.id}
                                className="border-dark-muted/15 bg-surface hover:border-dark-muted/50 hover-border-2 relative flex cursor-pointer flex-col gap-3 rounded-2xl border p-5 transition hover:scale-105"
