        ...
        <section className="bg-light">
            <div className="tablet:py-20 laptop:py-24 mx-auto max-w-6xl px-6 py-16">
                ...
                <div className="mx-auto text-center">
                    ...
                    <h2 className="text-dark laptop:text-4xl mt-4 text-3xl font-bold tracking-tight">
                        Tailor your resume in five precise steps
                    </h2>
                    <p className="text-dark-muted mt-3 text-base">
                ...
                <div className="tablet:grid-cols-2 laptop:grid-cols-3 desktop:grid-cols-5 mt-8 grid grid-cols-1 gap-4">
                    {mainWorkFlowSteps.map((s) => {
                        ...
                        return (
                            <div
                                key={s.id}
                                className="border-dark-muted/15 bg-surface relative flex cursor-pointer flex-col gap-3 rounded-2xl border p-5 transition hover:border-dark-muted/50 hover-border-2 hover:scale-105"
                            ...
                            >
                                ...
                                {isOpen && (
                                    <div className="border-dark-muted/25 border-t">
                                        <p className="text-dark-muted/90 mt-2 text-sm leading-relaxed whitespace-pre-line select-none">
                                            {s.more}
                                        </p>
                                    </div>
                                )}
